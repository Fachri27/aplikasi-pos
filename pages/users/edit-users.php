            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="form-user.php">Tambah Users</a>
                    </div>
                </div>
            </li>
                                    ...
                                    <form action="act_update.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="password" name="pass" value="<?= $data['password'] ?>" class="form-control">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <?php if($data['foto']==""){ ?>
                                                ...
                                                <br><br>
                                                <?php }else{ ?>
                                                <img src="gambar/<?= $data['foto'] ?>" height="50" width="50"><br>
                                                <label class="card-title">Foto :</label><br>
                                                <input type="file" name="foto" class="form-control-file">
                                                <br><br>
                                                <?php } ?>
