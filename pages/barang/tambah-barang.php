                    ...
                    <div class="row animate__animated animate__slideInLeft animate__slow 0.5s">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="act_barang.php" method="post">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label class="card-title">Nama Barang</label><br>
                                                <input type="text" name="nam_bar" class="form-control">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="card-title">Kategori</label><br>
