                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="act_update.php" method="post">
                                        <label class="card-title">Nama Kategori</label><br>
                                        <input type="hidden" name="id" value="<?= $data['id_kategori'] ?>">
                                        <input type="text" name="nam_kat" value="<?= $data['nama_kategori'] ?>" class="form-control">
                                        <input type="hidden" name="nam_katlama" value="<?= $data['nama_kategori'] ?>">
                                        <br><br> 
